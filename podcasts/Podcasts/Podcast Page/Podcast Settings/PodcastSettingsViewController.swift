...
class PodcastSettingsViewController: PCViewController {
    ...
    enum TableRow { case autoDownload, notifications, globalInbox, upNext, globalUpNext, upNextPosition, session, sessionPosition, globalSession, playbackEffects, skipFirst, skipLast, autoArchive, inFilters, siriShortcut, unsubscribe, feedError }
