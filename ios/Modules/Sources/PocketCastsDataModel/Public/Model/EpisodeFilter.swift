...
public class EpisodeFilter: NSObject {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case folderUuids
        case customOrderInsertMode
        case customOrderLastInsertedUuid
    }
    ...
    public required init(from decoder: Decoder) throws {
        ...
        folderUuids = try container.decodeIfPresent(String.self, forKey: .folderUuids) ?? ""
        customOrderInsertMode = try container.decodeIfPresent(Int32.self, forKey: .customOrderInsertMode) ?? 2
        customOrderLastInsertedUuid = try container.decodeIfPresent(String.self, forKey: .customOrderLastInsertedUuid) ?? ""
    }
    ...
    public func encode(to container: inout PersistenceContainer) {
        ...
        container["folderUuids"] = folderUuids
        container["customOrderInsertMode"] = customOrderInsertMode
        container["customOrderLastInsertedUuid"] = customOrderLastInsertedUuid
    }
    ...
    public enum Columns {
        ...
        public static let folderUuids = Column(CodingKeys.folderUuids)
        public static let customOrderInsertMode = Column(CodingKeys.customOrderInsertMode)
        public static let customOrderLastInsertedUuid = Column(CodingKeys.customOrderLastInsertedUuid)
    }
}
