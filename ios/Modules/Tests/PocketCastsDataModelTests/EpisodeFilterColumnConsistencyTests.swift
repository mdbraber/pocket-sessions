...
final class EpisodeFilterColumnConsistencyTests: DataManagerTestCase {
    ...
    func testDatabaseTableHasExpectedColumns() throws {
        ...
        XCTAssertEqual(
            ...
            ["filterDownloading", "showArchivedEpisodes", "newEpisodesAutoAdd"],
    ...
    func testSaveAndLoadPreservesAllFields() throws {
        try runWithDataManager { dataManager in
            ...
            XCTAssertEqual(loaded.folderUuids, original.folderUuids, "folderUuids should match")
            XCTAssertEqual(loaded.customOrderInsertMode, original.customOrderInsertMode, "customOrderInsertMode should match")
            XCTAssertEqual(loaded.customOrderLastInsertedUuid, original.customOrderLastInsertedUuid, "customOrderLastInsertedUuid should match")
    ...
    private func createFullyPopulatedEpisodeFilter() -> EpisodeFilter {
        ...
        filter.folderUuids = "folder1,folder2"
        filter.customOrderInsertMode = 1
        filter.customOrderLastInsertedUuid = "episode1"
        return filter
    }
}
